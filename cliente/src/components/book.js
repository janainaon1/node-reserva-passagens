...
export default props => {
  ...
  // Locais
  const [locations] = useState(['Curitiba', 'São Paulo', 'Maceió', 'Belo horizonte', 'Recife']);
  const [times] = useState(['9AM', '10AM', '11AM', '12PM', '1PM', '2PM', '3PM']);
  ...
  //Verificar disponibilidade de assentos na data e hora selecionada
  useEffect(() => {
